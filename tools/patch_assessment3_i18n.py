...
STRINGS = {
    ...
    "c.q.takehome_debt": "Gross salary ${gross}/month. Deductions: {k401}% to 401(k), {fed}% federal income tax, {ss}% Social Security, {med}% Medicare, {state}% state tax. Find 401(k) contribution, total taxes, take-home, and max consumer credit payment (15% of take-home).",
    "c.q.takehome_debt.deseret": "Household gross ${gross}/month. Put {k401}% in 401(k); withhold {fed}% federal, {ss}% Social Security, {med}% Medicare, {state}% state. Find 401(k), taxes, take-home, and 15% max consumer debt payment.",
    ...
    "c.q.dink_need.deseret": "DINK stewardship: you earn {yourPct}% of ${income} household income (spouse {spousePct}%), funeral ${funeral}, debts ${debts}. Life insurance need for yourself?",
    ...
    "c.q.six_keys": "Which set best matches common “keys to financial success” taught in this course?",
    "c.q.retire_rule": "Based on the study-guide rule of thumb, about how much of your pre-retirement income do you need after you retire?",
    # Hints
    "c.h.afford_car": "Find take-home after tax, take 15% of that, then subtract existing consumer debt.",
    "c.h.takehome_debt": "Apply each percent to gross; take-home excludes 401(k) and taxes; cap consumer debt at 15% of take-home.",
    "c.h.debt_guideline": "Consumer debt should stay near 15% of take-home pay.",
    "c.h.months_to_save": "Use the ordinary annuity formula and solve for n; always round up.",
    "c.h.mortgage_credit": "Financed = (price − down) + fee; then amortizing PMT, total paid, and cost of credit.",
    ...
    "c.h.dink_need": "DINK: funeral + debts + one year of your income share.",
    ...
    "c.h.six_keys": "Live within means, pay yourself first, avoid consumer debt, invest long-term.",
    "c.h.retire_rule": "Many guides use roughly 70–80% of pre-retirement income.",
    # Choices
    "c.c.true": "True",
    "c.c.false": "False",
    ...
    "c.c.six_keys_ans": "Live within your means, pay yourself first, eliminate consumer debt, save/invest consistently, protect with insurance, and keep learning",
